...
class AmendmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create amendment" do
    assert_difference('Amendment.count') do
      post amendments_url, params: { amendment: { budget_id: @amendment.budget_id, explanation: @amendment.explanation, number: @amendment.number, type: @amendment.type, user_id: @amendment.user_id } }
    end
  ...
  test "should update amendment" do
    patch amendment_url(@amendment), params: { amendment: { budget_id: @amendment.budget_id, explanation: @amendment.explanation, number: @amendment.number, type: @amendment.type, user_id: @amendment.user_id } }
